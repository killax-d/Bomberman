...
public class ItemPowerUp extends Item {
	...
	public ItemPowerUp(Vec2D position, Map map) {
		super(position, map);
		this.frame = 0;
		this.skin_id = 0;
	...
	public BufferedImage getSprite() {
		return Assets.getTile(String.format("skins/item_power_up_%d.png", skin_id), SPRITE_WIDTH, SPRITE_HEIGHT, this.frame, 0);
	}
